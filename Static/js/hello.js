...
function init() {
    ...
    gapi.client.load('guessnumber', 'v1', loadCallback, rootpath);
}
...
function enableButtons () {
    ...
    btn.value="Click me for create a 2 players game";
...
function greetGenerically () {
    ...
    var request = gapi.client.guessnumber.createTwoplayersGame();
